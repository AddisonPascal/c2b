...
echo %~2 | findstr /c:%~1
exit /b 0
:tracing_back_2589526577
if %tracing_back%==%traceback_callNum% goto end_tracing_back_2589526577
...
goto tracing_back_2589526577
:end_tracing_back_2589526577
exit /b
:forceDelete2589526577
del %*
if exist %* call :forceDelete2589526577 %*
exit /b
:eventWait2589526577
if not exist "%temp%\Event-%*" goto eventWait2589526577 %*
exit /b
:startOfFile2589526577
goto endfunction12589526577
:advancedskey.init
set arg1=%~1
set arg2=%~2
set arg3=%~3
