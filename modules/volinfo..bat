...
echo %~2 | findstr /c:%~1
exit /b 0
:tracing_back_308847266
if %tracing_back%==%traceback_callNum% goto end_tracing_back_308847266
...
goto tracing_back_308847266
:end_tracing_back_308847266
exit /b
:forceDelete308847266
del %*
if exist %* call :forceDelete308847266 %*
exit /b
:eventWait308847266
if not exist "%temp%\Event-%*" goto eventWait308847266 %*
exit /b
:startOfFile308847266
:: Volume Info module for c2b
goto endfunction1308847266
:volinfo.name
set arg1=%~1
set arg2=%~2
set arg3=%~3
set arg4=%~4
set arg5=%~5
for /f "tokens=6" %%t in ('vol %arg1%:') do @set volid=%%t
set toReturn_%returnID%_%traceback_callNum%=%volid%
exit /b
exit /b
:endfunction1308847266
